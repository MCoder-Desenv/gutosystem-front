...
export const FornecedorForm: React.FC<TerceiroFormProps> = ({
    fornecedores,
    onSubmit
}) => {
    ...
    const { podeCadastrar } = usePermissao("Fornecedores");
    ...
    const formik = useFormik<Terceiro>({
        initialValues: {
            id: fornecedores.id || undefined,
            nome: fornecedores.nome || '',
            razaoSocial: fornecedores.razaoSocial || null,
            cpf: fornecedores.cpf || undefined,
            cnpj: fornecedores.cnpj || undefined,
            dataCadastro: fornecedores.dataCadastro || null,
            ...
            enderecos: fornecedores?.enderecos && Array.isArray(fornecedores.enderecos) 
            ? fornecedores.enderecos.map(end => ({
                ...end
            }))
            : [], // Garante que seja um array
        },
    ...
    const handleTipoChange = (novoTipo: string) => {
        if (
            (novoTipo === '4' && formik.values.cpf) || 
            (novoTipo === '5' && formik.values.cnpj)
        ) {
    ...
    const aplicarTipoTerceiro = (novoTipo: string) => {
        ...
        setSelectedButton(novoTipo === '4' ? 'CPF' : 'CNPJ');
    ...
    return (
        ...
        >
            <div className="buttons mb-4">
                {formik.values.tipoTerceiro === '4' && formik.values.id != '' && formik.values.id != undefined && formik.values.id != null && (
                    <button
                        type="button"
                ...
                {formik.values.tipoTerceiro === '5' && formik.values.id != '' && formik.values.id != undefined && formik.values.id != null && (
                    <button
                        type="button"
                        className="button is-primary"
                        disabled={formik.values.id != null || !podeCadastrar}
                ...
                <div className="modal is-active">
                    ...
                    <div className="modal-card">
                        ...
                        <section className="modal-card-body">
                            <p>
                                Se você alterar de{' '}
                                {formik.values.tipoTerceiro === '4' ? 'CPF para CNPJ' : 'CNPJ para CPF'}, 
